...
public class ExecutorFilterReceive extends IoFilterAdapter {

	private final Executor executor;


	public ExecutorFilterReceive() {
		if( ThreadPoolManager.getInstance().Pool("receivePool") == null)
		{
		...
		{
			executor =ThreadPoolManager.getInstance().Pool("receivePool");
		}
	}
	 ...
	 */
	public ExecutorFilterReceive(Executor executor) {
		if (executor == null) {
