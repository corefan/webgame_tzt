...
import org.epilot.ccf.filter.flash.CodeFactory;
 ...
 */
public class ProtocolCodecFlashFilter extends IoFilterAdapter {
    public static final String ENCODER = ProtocolCodecFlashFilter.class.getName()
            + ".encoder";

    public static final String DECODER = ProtocolCodecFlashFilter.class.getName()
            + ".decoder";

    private static final String DECODER_OUT = ProtocolCodecFlashFilter.class.getName()
            + ".decoderOut";
    ...
    public ProtocolCodecFlashFilter(String name) {
       
       
        this.factory = new CodeFactory(name);
    }

    public ProtocolCodecFlashFilter(final ProtocolEncoder encoder,
    ...
    public ProtocolCodecFlashFilter(
    ...
    public void onPreAdd(IoFilterChain parent, String name,
        ...
        if (parent.contains(ProtocolCodecFlashFilter.class)) {
